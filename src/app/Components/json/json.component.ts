...
import { faArrowLeft, faBars, faBarsStaggered, faChevronDown, faChevronUp, faCopy, faDownload, faExpand, faFolder, faTrash } from '@fortawesome/free-solid-svg-icons';
...
@Component({
  selector: 'app-json',
  imports: [FormsModule, FontAwesomeModule, NavbarComponent],
